...
export function WhatsappButton() {
  ...
  return (
    <a
      ...
      className="fixed right-4 top-[60%] md:top-1/2 -translate-y-1/2 z-50 flex flex-row-reverse items-center gap-3 group"
    >
      {/* Circle button */}
      <div className="relative flex items-center justify-center w-10 h-10 md:w-14 md:h-14 rounded-full bg-[#F97316] shadow-[0_4px_24px_rgba(249,115,22,0.5)] transition-all duration-300 group-hover:scale-110 group-hover:shadow-[0_6px_32px_rgba(249,115,22,0.7)]">
        {/* Ping animation ring */}
